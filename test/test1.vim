...
"call s:assert_equals(s:expand[0].status_code , 200)
"call s:assert_equals(s:expand[0].long_url    , 'http://basyura.org')
"call s:assert_equals(s:expand[0].short_url   , 'http://bit.ly/fHgr3a')


"let s:expand = bitly#expand(['http://bit.ly/fHgr3a' , 'http://bit.ly/g2n8tN'])
"call s:assert_equals(s:expand[0].status_code , 200)
"call s:assert_equals(s:expand[0].long_url    , 'http://basyura.org')
"call s:assert_equals(s:expand[0].short_url   , 'http://bit.ly/fHgr3a')
"call s:assert_equals(s:expand[1].status_code , 200)
"call s:assert_equals(s:expand[1].long_url    , 'http://google.com')
"call s:assert_equals(s:expand[1].short_url   , 'http://bit.ly/g2n8tN')
