...
function! bitly#xml#createElement(name)
...
function! bitly#xml#parseFile(fname)
  return bitly#xml#parse(join(readfile(a:fname), "\n"))
endfunction

function! bitly#xml#parseURL(url)
  return bitly#xml#parse(bitly#http#get(a:url).content)
endfunction
